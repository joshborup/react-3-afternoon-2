...
class Edit extends Component {
    ...
    componentWillMount(){
        var customID = this.props.match.params.id;
        axios.get(`/api/blog/${customID}`).then(results => {
            this.setState({
    ...
    updatePost(){
        ...
        axios.put(`/api/blog/${customID}`, body).then(
    ...
    deletePost(){
        var customID = this.props.match.params.id;
        axios.delete(`/api/blog/${customID}`).then(
